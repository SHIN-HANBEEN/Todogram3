...
export const NavMenuItemLink = ({
  ...
  <a
    href={href}
    className={cx(
      'outline-focus-ring hover:bg-primary_hover inline-flex w-full gap-3 px-4 py-3 transition duration-100 ease-linear focus-visible:outline-2 sm:max-w-80 sm:p-3 md:rounded-lg',
      className
    )}
  >
    ...
    {isReactComponent(Icon) && (
      <Icon
        className={cx(
          'text-fg-brand-primary mt-0.5 size-4 shrink-0 stroke-[2.3px]',
          iconClassName
        )}
      />
    )}
