        ...
        <div className="flex w-full max-w-full min-w-0 flex-1">
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-0.5 flex items-center gap-2">
              <p className="text-tertiary truncate text-sm whitespace-nowrap">
              ...
              <div className="flex items-center gap-1">
                {isComplete && (
                  <CheckCircle className="text-fg-success-primary size-4 stroke-[2.5px]" />
                )}
                {isComplete && (
                  <p className="text-success-primary text-sm font-medium">
                    Complete
                  </p>
                )}

                {!isComplete && !failed && (
                  <UploadCloud02 className="text-fg-quaternary size-4 stroke-[2.5px]" />
                )}
                {!isComplete && !failed && (
                ...
                {failed && (
                  <p className="text-error-primary text-sm font-medium">
                    Failed
                  </p>
                )}
              </div>
...
export const FileListItemProgressFill = ({
  ...
  return (
    <motion.li
      layout="position"
      className={cx(
        'bg-primary relative flex gap-3 overflow-hidden rounded-xl p-4',
        className
      )}
    >
      {/* Progress fill. */}
      <div
        ...
        className={cx(
          'bg-secondary absolute inset-0 size-full transition duration-75 ease-linear',
