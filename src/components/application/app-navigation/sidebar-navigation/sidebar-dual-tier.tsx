...
export const SidebarNavigationDualTier = ({
  ...
  const mainSidebar = (
    <aside className="group bg-primary flex h-full max-h-full max-w-full overflow-y-auto">
      <div
        style={
          {
        ...
        className={cx(
          'border-secondary relative flex w-full flex-col border-r pt-4 transition duration-300 lg:w-(--width) lg:pt-5',
