...
export const PaginationPageDefault = ({
  ...
  return (
    <Pagination.Root
      ...
      total={total}
      className={cx(
        'border-secondary flex w-full items-center justify-between gap-3 border-t pt-4 md:pt-5',
        className
      )}
    >
  ...
  return (
    ...
    >
      ...
      >
        ...
        <hr
          className={cx(
            'border-primary mx-1 h-4 w-px border-l max-md:hidden',
            align === 'center' && 'hidden'
          )}
        />
