  ...
  return (
    <div {...otherProps} className={cx('relative h-30 w-40.25', className)}>
        ...
        <defs>
          ...
          >
            ...
            <stop
              offset="1"
              stopColor="currentColor"
              className="text-utility-neutral-50"
            />
          </linearGradient>
          <linearGradient
      ...
      {children && (
        <span
          className={cx(
            'bg-alpha-black/20 text-fg-white absolute inset-x-13 bottom-2 z-10 flex size-12 items-center justify-center rounded-full backdrop-blur-xs',
            childrenClassName
          )}
        >
          {children}
  ...
  return (
    <div {...otherProps} className={cx('relative h-34.25 w-46.25', className)}>
      ...
      {children && (
        <span
          className={cx(
            'bg-alpha-black/20 text-fg-white absolute bottom-3 left-1/2 z-10 flex size-14 -translate-x-1/2 items-center justify-center rounded-full backdrop-blur-xs',
            childrenClassName
          )}
        >
          {children}
  ...
  return (
    <div {...otherProps} className={cx('relative h-41.5 w-57.5', className)}>
      ...
      {children && (
        <span
          className={cx(
            'bg-alpha-black/20 text-fg-white absolute bottom-5 left-1/2 z-10 flex size-14 -translate-x-1/2 items-center justify-center rounded-full backdrop-blur-xs',
            childrenClassName
          )}
        >
          {children}
