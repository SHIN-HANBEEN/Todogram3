...
const styles = sortCx({
  ...
  gradient: {
    ...
    colors: {
      ...
      error:
        'before:border-utility-red-200 before:bg-utility-red-50 after:bg-error-solid',
      warning:
        'before:border-utility-yellow-200 before:bg-utility-yellow-50 after:bg-warning-solid',
      success:
        'before:border-utility-green-200 before:bg-utility-green-50 after:bg-success-solid',
    },
  },
