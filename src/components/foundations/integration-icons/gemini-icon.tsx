...
const GeminiIcon = ({
  grayscale,
  ...props
}: SVGProps<SVGSVGElement> & { grayscale?: boolean }) => {
  if (grayscale) {
    return (
    ...
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" {...props}>
      ...
      <defs>
        ...
        >
          ...
          />
          <feGaussianBlur
            stdDeviation="0.682227"
            result="effect1_foregroundBlur_12464_573808"
          />
        </filter>
        <filter
