    ...
    return (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" {...props}>
        <g clipPath="url(#clip0_nextjs_gray)">
          ...
          />
          <path
            d="M15.6798 4.24017H13.7598V15.7602H15.6798V4.24017Z"
            fill="url(#paint1_nextjs_gray)"
          />
        </g>
        <defs>
          <linearGradient
            id="paint0_nextjs_gray"
            x1="12.8"
            y1="14.2403"
            x2="18.48"
            y2="21.2803"
          ...
          >
            ...
            <stop
              offset="1"
              className="[stop-color:var(--color-fg-quaternary)]"
              stopOpacity="0"
            />
          </linearGradient>
          <linearGradient
            id="paint1_nextjs_gray"
            x1="14.7198"
            y1="4.24017"
            x2="14.6876"
            y2="12.7002"
