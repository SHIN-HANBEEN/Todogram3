      ...
      if (selectionIndicator === 'checkmark') {
        return (
          <Check
            aria-hidden="true"
            className={cx(
              'text-fg-brand-primary size-4 shrink-0 stroke-[2.25px]',
      ...
      {state => (
        ...
        >
          ...
          {Icon && (
            <Icon
              aria-hidden="true"
              className="text-fg-quaternary mr-2 size-4 shrink-0 stroke-[2.25px]"
            />
          )}

          <span
            className={cx(
              'text-secondary grow truncate text-sm font-semibold',
          ...
          {addon && (
            <span className="text-quaternary ml-1 shrink-0 pr-1 text-xs font-medium">
              {addon}
            </span>
          )}
          ...
          {state.hasSubmenu && (
            <ChevronRight
              aria-hidden="true"
              className="text-fg-quaternary ml-auto size-4 shrink-0 stroke-[2.25px]"
            />
          )}
        </div>
      )}
