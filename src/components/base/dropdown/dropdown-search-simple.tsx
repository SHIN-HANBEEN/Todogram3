    ...
    <Dropdown.Root>
      ...
      <Dropdown.Popover className="w-60">
        <Autocomplete filter={contains}>
          <SearchField className="border-secondary flex gap-3 border-b p-3">
