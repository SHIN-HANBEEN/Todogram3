...
export const ProgressBarBase = ({
  ...
  return (
    <div
      ...
      aria-valuemax={max}
      className={cx(
        'bg-quaternary h-2 w-full overflow-hidden rounded-md',
        className
      )}
    >
      <div
        ...
        className={cx(
          'bg-fg-brand-primary size-full rounded-md transition duration-75 ease-linear',
          progressClassName
        )}
      />
    </div>
    ...
    case 'right':
      return (
        <div className="flex items-center gap-3">
          {baseProgressBar}
          <span className="text-secondary shrink-0 text-sm font-medium tabular-nums">
            {formattedValue}
          </span>
        </div>
      )
    ...
    case 'top-floating':
      return (
        <div className="relative flex flex-col items-end gap-2">
          ...
          >
            <div className="text-secondary text-xs font-semibold tabular-nums">
              {formattedValue}
            </div>
          </div>
        </div>
