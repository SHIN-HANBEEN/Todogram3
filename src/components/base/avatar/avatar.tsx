  ...
  return (
    <div
      ...
      className={cx(
        ...
        // Focus styles
        focusable &&
          'group-focus-visible:outline-focus-ring outline-transparent group-focus-visible:outline-2 group-focus-visible:outline-offset-2',
