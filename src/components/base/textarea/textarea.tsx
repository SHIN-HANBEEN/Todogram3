...
export const TextAreaBase = ({
  ...
  return (
    <AriaTextArea
      ...
      className={state =>
        cx(
          'bg-primary text-primary ring-primary placeholder:text-placeholder autofill:text-primary w-full scroll-py-3 rounded-lg shadow-xs ring-1 transition duration-100 ease-linear ring-inset autofill:rounded-lg focus:outline-hidden',

          size === 'sm' && 'p-3 text-sm',
          size === 'md' && 'text-md px-3.5 py-3',
