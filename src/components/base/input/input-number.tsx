  ...
  return (
    <AriaGroup
      ...
      className={({ isFocusWithin, isDisabled, isInvalid }) =>
        cx(
          ...
          isInvalid &&
            isFocusWithin &&
            'outline-error outline-2 -outline-offset-2',
          isFocusWithin &&
            'group-invalid:outline-error group-invalid:outline-2 group-invalid:-outline-offset-2',
    ...
    >
      ...
      {orientation === 'vertical' && (
        <div
          className={cx(
            'border-primary flex w-7 shrink-0 flex-col border-l',
            size === 'lg' && 'w-7.5'
          )}
        >
          <AriaButton
