...
const searchSizes = {
  ...
  md: {
    wrapper: 'py-0.5',
    root: 'px-3 py-2 gap-2 *:data-icon:size-5',
    text: 'text-md',
  },
  lg: {
    wrapper: 'py-0.5',
    root: 'px-3.5 py-2.5 gap-2 *:data-icon:size-5',
    text: 'text-md',
  },
}
...
const MultiSelectFooter = ({
  ...
  return (
    <div
      className={cx(
        'border-secondary flex items-center justify-between border-t p-3',
        className
      )}
    >
        ...
        <AriaDialogTrigger>
          ...
          >
            ...
            >
              {hasSelection ? (
                <span
                  className={cx('flex items-center', sizes[size].textContainer)}
                >
                  <span
                    className={cx('text-primary font-medium', sizes[size].text)}
                  >
                    {selectedCountFormatter
                  ...
                  {supportingText && (
                    <span className={cx('text-tertiary', sizes[size].text)}>
                      {supportingText}
                    </span>
                  )}
                </span>
              ) : (
                <span className={cx('text-placeholder', sizes[size].text)}>
                  {placeholder}
                </span>
              )}
          ...
          <AriaPopover
            ...
            className={state =>
              cx(
                'bg-primary ring-secondary_alt w-(--trigger-width) origin-(--trigger-anchor-point) overflow-hidden rounded-lg shadow-lg ring-1 outline-hidden will-change-transform',
                state.isEntering &&
                    ...
                    >
                      ...
                      >
                        ...
                        <AriaInput
                          placeholder="Search"
                          className={cx(
                            'text-primary caret-alpha-black/90 placeholder:text-placeholder w-full appearance-none bg-transparent outline-hidden',
